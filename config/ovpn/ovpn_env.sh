...
declare -x OVPN_PORT=3000
declare -x OVPN_PROTO=udp
declare -x OVPN_PUSH=()
declare -x OVPN_ROUTES=([0]="10.70.254.0/24")
declare -x OVPN_SERVER=10.70.255.0/24
declare -x OVPN_SERVER_URL=udp://0.0.0.0:3000
